...
class ProfileSignup extends StatefulWidget {
  ...
  ProfileSignup({this.user}){
    print(user?.email??null);
  }
  @override
  _ProfileSignupState createState() => _ProfileSignupState(user: user);
}
class _ProfileSignupState extends State<ProfileSignup> {
var _nameController=TextEditingController();

FirebaseUser user;
_ProfileSignupState({this.user}){
  print(user?.email??null);
}
...
_fromCamera(BuildContext context,int index)async{
  ...
  Future toFormScreen() async{
    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>FormScreen(name: _nameController.text,user:user)));
  }
...
//Widget ImageDisplay(int index){
//  if(_checkIfExists(index)==true)
//  return Image.file(image[index],fit: BoxFit.cover,);
//  else
//    return null;
//}
//bool _checkIfExists(int index){
//  File tempImage;
//  try{
//    tempImage=image[index];
//  }
//  catch(e){
//  }
//  if(tempImage==null)
